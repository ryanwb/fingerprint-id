% MEDIAN FILTER (2D) (MATLAB IMPLEMENTATION) Algorithm Source: http://angeljohnsy.blogspot.com/2011/03/2d-median-filtering-for-salt-and-pepper.html

%READ AN 2D IMAGE
A=imread('test.jpg');
%title('IMAGE WITH S&P NOISE');
A=rgb2gray(A);
figure,imshow(A); %Show Image
